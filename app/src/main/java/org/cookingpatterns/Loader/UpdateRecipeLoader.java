...
import org.cookingpatterns.EventMessages.OnUpdateRecipeResponseEvent;
import org.cookingpatterns.Model.Recipe;

/**
 * Created by Andreas on 25.11.2015.
 */
public class UpdateRecipeLoader extends DataLoader<Recipe> {
    public UpdateRecipeLoader(Context context, Bundle args) {
        super(context, args);
    }
    ...
    public Recipe call(Bundle args) {
        ...
        DataProviderManager.getInstance(mContext).getActiveDataProvider().updateRecipe(recipe);
        return recipe;
    }
